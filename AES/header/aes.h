...
Block128 sub_bytes(Block128 state) {
    for (unsigned char i = 0; i < 16; ++i) state.cells[i] = sbox[state.cells[i]]; return state;
}
Block128 inv_sub_bytes(Block128 state) {
    static const unsigned char rbox[256] = {  };
    for (unsigned char i = 0; i < 16; ++i) state.cells[i] = rbox[state.cells[i]]; return state;
}

Block128 shift_rows(Block128 state) {
    Block128 new_state = {
...
Block128 inv_shift_rows(Block128 state) {
    Block128 new_state = {
...
unsigned int g(unsigned int word, unsigned char round) {
...
void gen_key_schedule_128(Block128* keys) {
...
Block128 _aes_encryption(Block128 state, Block128* keys) {
    ...
    for (unsigned char i = 0; i < 9; ++i) {
        ...
        key_ptr += 2; add_round_key(state_ptr, key_ptr);
    }
    state = sub_bytes(state);
    state = shift_rows(state);
    key_ptr += 2; add_round_key(state_ptr, key_ptr);
...
Block128 _aes_decryption(Block128 state, Block128* keys) {
    unsigned long long* state_ptr = (unsigned long long*) & state;
